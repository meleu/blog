...
## meleu em 15 segundos

Engenheiro de Software e [entusiasta do open source](https://github.com/meleu).

Atualmente trabalhando como [Especialista DevOps](https://www.linkedin.com/in/meleu/).

Um nerd do Linux desde o final dos anos 90, eu vivo no terminal e escrevo sobre truques da linha de comando e programação shell (em [português](https://meleu.sh/) e [inglês](https://meleu.sh/en/)).

Um grande fã de jogos retrô. Entre 2016-2021 eu dediquei um boa parte do meu tempo a projetos open source relacionados a este hobby (principalmente [RetroAchievements](https://retroachievements.org)).

Eu também sou um ávido leitor de livros.
